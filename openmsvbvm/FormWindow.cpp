...
static void BorderStyleToWindowStyle(
	BYTE	borderStyle,
	bool	controlBox,
	bool	maxButton,
	bool	minButton,
 ...
 * vbFormWrapper::TryFireQueryUnload's documented, explicitly-scoped heuristic and
 * its limitations) -- if the handler sets Cancel, the close is aborted, matching real
 * VB6 semantics. No other intrinsic events (Unload, Resize, Click, ...) are dispatched
 * yet.
 */
static LRESULT CALLBACK FormWndProc(
	HWND	hwnd,
	UINT	msg,
	WPARAM	wParam,
	LPARAM	lParam
